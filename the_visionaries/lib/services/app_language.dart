...
const Map<AppLanguage, Map<String, String>> _localizedValues = {
  AppLanguage.spanish: {
    ...
    'hipaa_note': 'Diseñado con salvaguardas de seguridad alineadas con HIPAA.',
    ...
    'dev_skip_control': 'Ir al control (DEV)',
    ...
    'control_popup_skip_dev': 'Saltar (DEV)',
  ...
  AppLanguage.english: {
    ...
    'hipaa_note': 'Designed with HIPAA-aligned security safeguards.',
  ...
  AppLanguage.german: {
    ...
    'hipaa_note': 'Entwickelt mit HIPAA-konformen Sicherheitsmaßnahmen.',
    ...
    'dev_skip_control': 'Zum Steuerfeld (DEV)',
    'control_popup_message':
    ...
    'control_popup_skip_dev': 'Überspringen (DEV)',
  ...
  AppLanguage.guarani: {
    ...
    'hipaa_note': 'Ojejapo HIPAA rehegua seguridad ndive.',
    'control_title': 'Panel de control',
